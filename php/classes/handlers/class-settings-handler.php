...
class Settings_Handler {
	...
	public function settings_fields() {
		...
		$subcategory_options = array(
			...
			'Religion'       => array(
				'label' => __( 'Religion', 'simple-podcasting' ),
				'group' => __( 'Religion & Spirituality', 'simple-podcasting' ),
			),
			'Astronomy'          => array(
		...
		$settings['player-settings'] = array(
			...
			'fields'      => array(
				...
				array(
					...
					'label'       => __( 'Show subscribe urls', 'simple-podcasting' ),
					'description' => __( 'Turn on to display subscribe urls under the player', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
		...
		if ( 'larger' === $ss_podcasting_player_style ) {
			$html_5_player_settings = array(
				...
				array(
					...
					'label'       => __( 'Show subscribe button', 'simple-podcasting' ),
					'description' => __( 'Turn on to display the subscribe button', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'share_button_enabled',
					'label'       => __( 'Show share button', 'simple-podcasting' ),
					'description' => __( 'Turn on to display the share button', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
			);
		...
		if ( $meta_data_enabled ) {
			$meta_settings = array(
				array(
					...
					'label'       => __( 'Show download file link', 'simple-podcasting' ),
					'description' => __( 'Turn on to display the download file link', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'play_in_new_window_enabled',
					'label'       => __( 'Show play in new window link', 'simple-podcasting' ),
					'description' => __( 'Turn on to display the play in new window link', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'duration_enabled',
					'label'       => __( 'Show duration', 'simple-podcasting' ),
					'description' => __( 'Turn on to display the track duration information', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'date_recorded_enabled',
					'label'       => __( 'Show recorded date', 'simple-podcasting' ),
					'description' => __( 'Turn on to display the recorded date information', 'simple-podcasting' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
			);
		...
		$feed_details_fields = array(
			...
			array(
				...
				'description' => __( 'The podcast cover image must be between 1400x1400px and 3000x3000px in size and either .jpg or .png file format', 'simple-podcasting' ),
				'type'        => 'image',
				'default'     => '',
				'placeholder' => '',
