		...
		if ( $meta_data_enabled ) {
			$meta_settings = array(
				array(
					...
					'label'       => __( 'Show download file link', 'pds-podcast' ),
					'description' => __( 'Turn on to display the download file link', 'pds-podcast' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'play_in_new_window_enabled',
					'label'       => __( 'Show play in new window link', 'pds-podcast' ),
					'description' => __( 'Turn on to display the play in new window link', 'pds-podcast' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'duration_enabled',
					'label'       => __( 'Show duration', 'pds-podcast' ),
					'description' => __( 'Turn on to display the track duration information', 'pds-podcast' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
				array(
					'id'          => 'date_recorded_enabled',
					'label'       => __( 'Show recorded date', 'pds-podcast' ),
					'description' => __( 'Turn on to display the recorded date information', 'pds-podcast' ),
					'type'        => 'checkbox',
					'default'     => 'on',
				),
			);
